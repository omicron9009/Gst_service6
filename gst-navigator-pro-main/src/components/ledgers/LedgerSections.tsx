...
export function LedgerSections() {
  ...
  const cashBalance = getData('ledger_cash_balance');
  const cashTxn = getData('ledger_cash_txn');
  const itcTxn = getData('ledger_itc_txn');
  const liabilityTxn = getData('ledger_liability_txn');
