...
def export_to_excel(matched, un_books, un_2b,
    ...
    # ---- Cross-check section (updated format) ----
    cross_check_data = {
        "Position / Category": [
            "",
            "Position / Category",
        ...
        "Taxable Value": [
            ...
            "",
            "", "=C3",
            f"={_get_total_cell('Matched', matched, '2B Taxable Amt.')}",
            "=C6", "=C18+C19", "=C17-C20",
        ],
        "IGST": [
            "", "IGST",
            ...
            "",
            "", "=D3",
            f"={_get_total_cell('Matched', matched, '2B IGST')}",
            "=D6", "=D18+D19", "=D17-D20",
        ],
        "CGST": [
            "", "CGST",
            ...
            "",
            "", "=E3",
            f"={_get_total_cell('Matched', matched, '2B CGST')}",
            "=E6", "=E18+E19", "=E17-E20",
        ],
        "SGST": [
            "", "SGST",
            ...
            "",
            "", "=F3",
            f"={_get_total_cell('Matched', matched, '2B SGST')}",
            "=F6", "=F18+F19", "=F17-F20",
        ],
        "Total Tax Amount": [
            "", "Total Tax Amount",
            ...
            "",
            "", "=G3",
            f"={_get_total_cell('Matched', matched, '2B Total Tax')}",
            "=G6", "=G18+G19", "=G17-G20",
        ],
    }
...
def export_to_excel_combined(
    ...
    # ---- B2B Cross-check (updated format) ----
    summary_rows += [
        [],
        ["", "", "", "", "", "", ""],
        ...
        ["   -> Matched (Books figures)", "=B6", "=C6", "=D6", "=E6", "=F6", "=G6"],
        ["   -> Books Not in 2B", "=B7", "=C7", "=D7", "=E7", "=F7", "=G7"],
        ["   -> Total Accounted For", "=B12+B13", "=C12+C13", "=D12+D13", "=E12+E13", "=F12+F13", "=G12+G13"],
        ["   -> Books Variance (Difference)", "=B11-B14", "=C11-C14", "=D11-D14", "=E11-E14", "=F11-F14", "=G11-G14"],
        [],
        ["[B2B CROSS CHECK] 2. GSTR-2B Validation", "", "", "", "", "", ""],
        ["   -> Total from Uploaded GSTR 2B", "=B4", "=C4", "=D4", "=E4", "=F4", "=G4"],
        [
            "   -> Matched (2B figures)", "=B6",
            f"={_get_total_cell('B2B_Matched', b2b_matched, '2B Taxable Amt.')}",
            f"={_get_total_cell('B2B_Matched', b2b_matched, '2B IGST')}",
            f"={_get_total_cell('B2B_Matched', b2b_matched, '2B CGST')}",
            f"={_get_total_cell('B2B_Matched', b2b_matched, '2B SGST')}",
            f"={_get_total_cell('B2B_Matched', b2b_matched, '2B Total Tax')}",
        ],
        ["   -> 2B Not in Books", "=B8", "=C8", "=D8", "=E8", "=F8", "=G8"],
        ["   -> Total Accounted For", "=B19+B20", "=C19+C20", "=D19+D20", "=E19+E20", "=F19+F20", "=G19+G20"],
        ["   -> 2B Variance (Difference)", "=B18-B21", "=C18-C21", "=D18-D21", "=E18-E21", "=F18-F21", "=G18-G21"],
    ]
